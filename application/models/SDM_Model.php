...
class SDM_Model extends CI_Model
{
    public function tambahData()
    {
        $data = [
            ...
            "dlp5" => $this->input->post('sdmdlp5', true),
            ...
            "nutrisionis1" => $this->input->post('sdmnutrisionis1', true),
            "nutrisionis2" => $this->input->post('sdmnutrisionis2', true),
            "nutrisionis3" => $this->input->post('sdmnutrisionis3', true),
            "nutrisionis4" => $this->input->post('sdmnutrisionis4', true),
            "nutrisionis5" => $this->input->post('sdmnutrisionis5', true),
            "nutrisionis6" => $this->input->post('sdmnutrisionis6', true),
            ...
            "tatausaha2" => $this->input->post('sdmtatausaha2', true),
    ...
    public function ubahData()
    {
        ...
        $this->db->update('sumber_daya_manusia', $data);
    }
}
