...
class Indikator_Program extends CI_Controller
{
    ...
    public function tambah()
    {
        ...
        $this->form_validation->set_rules('cakupan_a1c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_a2c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_a3c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_b1c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_c1c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_d1c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_d2c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_d3c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_d4c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_d5c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_d6c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_d7c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_d8c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_e1c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_e2c', '', 'trim|in_list[1,2,3]');
        ...
        $this->form_validation->set_rules('cakupan_e3c', '', 'trim|in_list[1,2,3]');
