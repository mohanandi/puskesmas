			...
			<form>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="penilaian9" id="penilaian9" disabled>
                    <option selected>Pilih ...</option>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="penilaian10" id="penilaian10" disabled>
                    ...
                    <option value="3">
                      < 0,500 </option> </select> </div> <a class="btn float-right btn-danger" href="table.html" style="color: white; margin-left:10px; margin-top:5px; border-radius:5px;">Edit</a>
              </form>
