              ...
              <div class='multitab-section'>
                  ...
                  <span class='sidebar' id='sidebartab1' preferred='yes'>
                    <form>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="" name="organisasi2" id="organisasi2">
                      </div>
                      <div class="form-group">
                        <label for="exampleFormControlInput1">Kategori Puskesmas</label>
                        <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="" name="organisasi3" id="organisasi3">
                      </div>
                      <div class="form-group">
                        <label for="exampleFormControlInput1">Status Akreditasi</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="organisasi4" id="organisasi4">
                      </div>
                      <div class="form-group">
                        <label for="exampleFormControlInput1">Puskesmas mempunyai dokumen pengelolaan lingkungan (UKL/UPL atau PPLH)</label>
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="organisasi5" id="organisasi5">
                      </div>
                  ...
                  <span class='sidebar' id='sidebartab4' preferred='yes'>
                    <form>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana2.1" id="prasarana2.1">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana2.2" id="prasarana2.2">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana2.3" id="prasarana2.3">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana2.4" id="prasarana2.4">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.1" id="prasarana3.1">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.2" id="prasarana3.2">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.3" id="prasarana3.3">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.4" id="prasarana3.4">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.5" id="prasarana3.5">
                          <option selected>Pilih ...</option>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.6" id="prasarana3.6">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.7" id="prasarana3.7">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.8" id="prasarana3.8">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.9" id="prasarana3.9">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.10" id="prasarana3.10">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.11" id="prasarana3.11">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.12" id="prasarana3.12">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.13" id="prasarana3.13">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana3.14" id="prasarana3.14">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana4.1" id="prasarana4.1">
                          <option selected>Pilih ...</option>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="VA belom disamping" name="prasarana4.2" id="prasarana4.2">
                      </div>
                      <div class="form-group">
                        <label for="exampleFormControlInput1">Sumber daya listrik cadangan/darurat</label>
                        <select class="form-control" name="prasarana4.3" id="prasarana4.3">
                          <option selected>Pilih ...</option>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="VA belom disamping" name="prasarana4.4" id="prasarana4.4">
                      </div>
                      <div class="form-group">
                        <label for="exampleFormControlInput1">Listrik tersedia 24 jam dalam sehari</label>
                        <select class="form-control" name="prasarana4.5" id="prasarana4.5">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana4.6" id="prasarana4.6">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana4.7" id="prasarana4.7">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana4.8" id="prasarana4.8">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana5.a" id="prasarana5.a">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana5.b" id="prasarana5.b">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana5.c" id="prasarana5.c">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana5.d" id="prasarana5.d">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana5.e" id="prasarana5.e">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana5.f" id="prasarana5.f">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana5.g" id="prasarana5.g">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana5.h" id="prasarana5.h">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana5.i" id="prasarana5.i">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana6.1" id="prasarana6.1">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="prasarana6.2" id="prasarana6.2">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya</option>
                          <option value="2">Tidak</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col">
                            <input type="text" class="form-control" placeholder="..." name="prasarana11.a1" id="prasarana10.a1">
                          </div>
                          <div class="col">
                            <label>Unit</label>
                          </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col">
                            <input type="text" class="form-control" placeholder="..." name="prasarana11.b1" id="prasarana11.b1">
                          </div>
                          <div class="col">
                            <label>Unit</label>
                          </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col">
                            <input type="text" class="form-control" placeholder="..." name="prasarana11.c1" id="prasarana11.c1">
                          </div>
                          <div class="col">
                            <label>Unit</label>
                          </div>
                ...
                <div class='-content multitab-widget-content-widget-id' id='multicolumn-widget-id5'>
                  <span class='sidebar' id='sidebartab5' preferred='yes'>
                    <form>
                      <div class="form-group">
                        <label for="exampleFormControlInput1"><br>1. Set Pemeriksaan Umum</label>
                ...
                <div class='-content multitab-widget-content-widget-id' id='multicolumn-widget-id6'>
                  <span class='sidebar' id='sidebartab6' preferred='yes'>
                    <form>
                      <div class="form-group">
                ...
                <div class='-content multitab-widget-content-widget-id' id='multicolumn-widget-id7'>
                  <span class='sidebar' id='sidebartab7' preferred='yes'>
                    <form>
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="container">
                            <div class="row">
                              ...
                              <div class="col-md-2">
                                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="PNS" name="sdmdokter1" id="sdmdokter1">
                              </div>
                              <div class="col-md-2">
                                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="PPPK" name="sdmdokter2" id="sdmdokter2">
                              </div>
                              <div class="col-md-2">
                                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="NS" name="sdmdokter3" id="sdmdokter3">
                              </div>
                              <div class="col-md-2">
                                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="PTT DAERAH" name="sdmdokter4" id="sdmdokter4">
                              </div>
                              <div class="col-md-2">
                ...
                <div class='-content multitab-widget-content-widget-id' id='multicolumn-widget-id8'>
                  <span class='sidebar' id='sidebartab8' preferred='yes'>
                    <form>
                      <div class="form-group">
                        ...
                        <select class="form-control" name="penilaian1" id="penilaian1">
                          <option selected>Pilih ...</option>
                          <option value="1">Ya (Bukti Ditunjukkan)</option>
                          <option value="2">Tidak</option>
                        </select>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="penilaian10" id="penilaian10">
                          ...
                          <option value="3">
                            < 0,500 </option> </select> </div> <a class="btn float-right btn-success" href="table.html" style="color: white; margin-left:10px; margin-top:5px; border-radius:5px;">Masukan</a>
                    </form>
