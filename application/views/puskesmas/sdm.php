<div class="site-section" id = "menu">
  ...
  <form  method="POST" action="<?= base_url('SDM_Puskesmas/tambah'); ?>" style=" padding:20px;">
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<?php if ($data) : ?>
										<input type="number" class="form-control" id="exampleFormControlInput1" placeholder="" name="sdmtitik1" id="sdmtitik1" value="<?= $data['titik1']; ?>">
									<?php else : ?>
										<input type="number" class="form-control" id="exampleFormControlInput1" placeholder="" name="sdmtitik1" id="sdmtitik1" value="<?= set_value('sdmtitik1') ?>">
									<?php endif; ?>
