								...
								<div class="form-group">
									<div class="container">
										<div class="row">
											...
											<div class="col-md-2">
												<?php if ($data) : ?>
													<input type="text" class="form-control" id="exampleFormControlInput1" placeholder="PNS" name="sdmdokter1" id="sdmdokter1" value="<?= $data['']; ?>">
												<?php else : ?>
											...
											<div class="col-md-2">
												<?php if ($data) : ?>
													<input type="text" class="form-control" id="exampleFormControlInput1" placeholder="PNS" name="sdmdokter2" id="sdmdokter2" value="<?= $data['']; ?>">
												<?php else : ?>
