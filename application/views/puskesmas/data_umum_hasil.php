              ...
              <span class='sidebar' id='sidebartab1' preferred='yes'>
                <form>
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" value="" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Tanggal terbit izin operasional Puskesmas</label>
                    <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="" value="" readonly>
                  </div>
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Kategori Puskesmas</label>
                    <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="" value="" readonly>
                  </div>
                  <div class="form-group">
              ...
              <span class='sidebar' id='sidebartab4' preferred='yes'>
                <form>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="VA belom disamping" name="prasarana4.2" id="prasarana4.2" value="" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="VA belom disamping" name="prasarana4.4" id="prasarana4.4" value="" readonly>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col">
                        <input type="text" class="form-control" placeholder="..." name="prasarana11.a1" id="prasarana10.a1" value="" readonly>
                      </div>
                      <div class="col">
                        <label>Unit</label>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col">
                        <input type="text" class="form-control" placeholder="..." name="prasarana11.b1" id="prasarana11.b1" value="" readonly>
                      </div>
                      <div class="col">
                        <label>Unit</label>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col">
                        <input type="text" class="form-control" placeholder="..." name="prasarana11.c1" id="prasarana11.c1" value="" readonly>
                      </div>
                      <div class="col">
                        <label>Unit</label>
                      </div>
