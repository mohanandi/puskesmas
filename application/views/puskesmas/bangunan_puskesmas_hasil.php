<div class="site-section" id="menu">
  <div class="container">
    ...
    <form>
      ...
      <div class="form-group">
        <label for="exampleFormControlInput1">Atap Puskesmas kuat, tidak bocor, tahan lama dalam kondisi baik, rapi dan bersih </label>
      ...
      <div class="form-group">
        <label for="exampleFormControlInput1">Terdapat taman obat yang tertata rapi di area Puskesmas</label>
        <input type="text" class="form-control" value="<?= $data['taman_obat']; ?>" placeholder="" name="bangunan32" id="bangunan32" readonly>

      </div>
      <div class="form-group">
        <label for="exampleFormControlInput1">Puskesmas bebas dari asap rokok </label>
      ...
      <div class="form-group">
        <label for="exampleFormControlInput1">Angka rata-rata populasi lalat < 2 ekor</label> <input type="text" class="form-control" value="<?= $data['populasi_lalat']; ?>" placeholder="" name="bangunan38" id="bangunan38" readonly>
      </div>
      <div class="form-group">
        <label for="exampleFormControlInput1">Angka rata-rata populasi kecoa < 2 ekor</label> <input type="text" class="form-control" value="<?= $data['populasi_kecoa']; ?>" placeholder="" name="bangunan39" id="bangunan39" readonly>
            <select class="form-control" name="bangunan39" id="bangunan39" disabled>
      ...
      <div class="form-group">
        ...
        <select class="form-control" name="bangunan42_9b" id="bangunan42.9b" disabled>
