      ...
      <div class="col-md-9">
        <form style="height:350px; overflow-y:auto; padding:20px;">
          <div class="form-group">
            ...
            <select class="form-control" name="perencanaan1.a" id="perencanaan1.a">
            ...
            <select class="form-control" name="perencanaan1.b1" id="perencanaan1.b1">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.b2" id="perencanaan1.b2">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.b3" id="perencanaan1.b3">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.c" id="perencanaan1.c">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.d1" id="perencanaan1.d1">
              <option selected>Pilih ...</option>
            ...
            <br>
            <select class="form-control" name="perencanaan1.d2a" id="perencanaan1.d2a">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.d2b" id="perencanaan1.d2b">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.d2c" id="perencanaan1.d2c">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.d3" id="perencanaan1.d3">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.d4" id="perencanaan1.d4">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.d5" id="perencanaan1.d5">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.d6" id="perencanaan1.d6">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.d7" id="perencanaan1.d7">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.d8" id="perencanaan1.d8">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.d9" id="perencanaan1.d9">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan1.d10" id="perencanaan1.d10">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan2c" id="perencanaan" 2c>
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan3c.1" id="perencanaan3c.1">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan3c.2" id="perencanaan3c.2">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan3c.3" id="perencanaan3c.3">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan3c.4" id="perencanaan3c.4">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control " name="perencanaan3c.5" id="perencanaan3c.5">
              <option selected>Pilih ...</option>
              <option value="1">ada dokumen tindak lanjut </option>
              <option value="2">tidak ada dokumen tindak lanjut </option>
            </select>
            ...
            <select class="form-control" name="perencanaan3c.6" id="perencanaan3c.6">
              <option selected>Pilih ...</option>
            ...
            <select class="form-control" name="perencanaan3c.7" id="perencanaan3c.7">
              <option selected>Pilih ...</option>
