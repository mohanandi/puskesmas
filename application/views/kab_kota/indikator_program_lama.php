<div class="col-md-9">
  <form style=" ; padding:20px;">
    ...
    <div class="form-group">
      ...
      <br>
      <p id="foo30" style="display:none; font-size:12px; margin-left:20px;"> <br> | Ya=25% Tidak=0 <br> | % bayi baru lahir mendapatkan pelayanan neonatal esensial sesuai standar dikali 50% </p>
      <label for="exampleFormControlInput1">a. Tersedia regulasi internal program pelayanan bayi baru lahir (SK, SOP, Pedoman, Panduan) </label>
