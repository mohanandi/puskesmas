  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-lg-7 mx-auto text-center">
        ...
        <h2 class="heading"><strong class="text-primary">Indikator Program</strong></h2>
      </div>
    </div>
    <?php if ($data) {
      $link = '';
    ...
    <form style=" padding:20px;" method="POST" action="<?= $link; ?>">
      ...
      <div class="form-group">
        ...
        <p style="font-size:12px;">
          1. tercapai ≥ 80%, nilai 10 <br>
          2. tercapai 61 % - 79 % nilai 5 <br>
          3. tercapai ≤ 60%, nilai 0
      ...
      <div class="form-group">
        ...
        <p style="font-size:12px;">
          ...
          <select class="form-control" name="cakupan3a" id="cakupan3a">
            <?php is_terisi($data['kia3'], set_value('cakupan3a')); ?>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
          </select>
          <?= form_error('cakupan3a', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
      <hr>
      <div class="form-group">
        ...
        <p style="font-size:12px;">
          ...
          <select class="form-control" name="cakupan1b" id="cakupan1b">
            <?php is_terisi($data['imunisasi1'], set_value('cakupan1b')); ?>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
          </select>
          <?= form_error('cakupan1b', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
      <hr>
      <div class="form-group">
        ...
        <p style="font-size:12px;">
          ...
          <select class="form-control" name="cakupan1c" id="cakupan1c">
            <?php is_terisi($data['gizi1'], set_value('cakupan1c')); ?>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
          </select>
          <?= form_error('cakupan1c', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
      <hr>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <p style="font-size:12px;">
          ...
          <select class="form-control" name="cakupan3d" id="cakupan3d">
            <?php is_terisi($data['pencegahan3'], set_value('cakupan3d')); ?>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
          </select>
          <?= form_error('cakupan3d', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <p style="font-size:12px;">
          ...
          <select class="form-control" name="cakupan6d" id="cakupan6d">
            <?php is_terisi($data['pencegahan6'], set_value('cakupan6d')); ?>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
          </select>
          <?= form_error('cakupan6d', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
      <div class="form-group">
        ...
        <p style="font-size:12px;">
          ...
          <select class="form-control" name="cakupan7d" id="cakupan7d">
            <?php is_terisi($data['pencegahan7'], set_value('cakupan7d')); ?>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
          </select>
          <?= form_error('cakupan7d', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
      <div class="form-group">
        ...
        <p style="font-size:12px;">
          ...
          <select class="form-control" name="cakupan8d" id="cakupan8d">
            <?php is_terisi($data['pencegahan8'], set_value('cakupan8d')); ?>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
          </select>
          <?= form_error('cakupan8d', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
      <hr>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <p style="font-size:12px;">
          ...
          <select class="form-control" name="cakupan3e" id="cakupan3e">
            <?php is_terisi($data['pispk3'], set_value('cakupan3e')); ?>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
          </select>
          <?= form_error('cakupan3e', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
