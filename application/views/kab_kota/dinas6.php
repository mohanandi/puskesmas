  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-lg-7 mx-auto text-center">
        <span class="subheading">VI</span>
        <h2 class="heading" style="font-size:30px;"><strong class="text-primary">Pencegahan dan Pengendalian Infeksi dan Kesehatan Lingkungan</strong></h2>
      </div>
    </div>
