  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-lg-7 mx-auto text-center">
        <span class="subheading">XI</span>
        <h2 class="heading"><strong class="text-primary">Rencana Tidak Lanjut</strong></h2>
      </div>
    </div>
          ...
          <div class="form-group">
            ...
            <div class="con">
              <div class="row">
                ...
                <div class="col-md-4">
                  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="rencana1" id="rencana1">
                </div>
                <div class="col-md-4">
                  <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="" name="rencanatgl1" id="rencanatgl1">
                </div>
                <div class="col-md-4">
                  <label for="exampleFormControlInput1">2.</label>
                </div>
                <div class="col-md-4">
                  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="rencana2" id="rencana2">
                </div>
                <div class="col-md-4">
                  <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="" name="rencanatgl2" id="rencanatgl2">
                </div>
                <div class="col-md-4">
                  <label for="exampleFormControlInput1">3.</label>
                </div>
                <div class="col-md-4">
                  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="rencana3" id="rencana3">
                </div>
                <div class="col-md-4">
                  <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="" name="rencanatgl3" id="rencanatgl3">
                </div>
                <div class="col-md-4">
                  <label for="exampleFormControlInput1">4.</label>
                </div>
                <div class="col-md-4">
                  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="" name="rencana4" id="rencana4">
                </div>
                <div class="col-md-4">
                  <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="" name="rencanatgl4" id="rencanatgl4">
                </div>
                <div class="col-md-4">
                  <label for="exampleFormControlInput1">5.</label>
                </div>
                <div class="col-md-4">
                  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="DST" name="rencana5" id="rencana5">
                </div>
                <div class="col-md-4">
                  <input type="date" class="form-control" id="exampleFormControlInput1" placeholder="DST" name="rencanatgl5" id="rencanatgl5">
                </div>
              </div>
            </div>
          </div>
