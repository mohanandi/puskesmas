              ...
              <span class='sidebar' id='sidebartab3' preferred='yes'>
                <form>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="VA belom disamping">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1"><strong> SISTEM PENCAHAYAAN</strong></label><br>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1"><strong> PUSKESMAS KELILING DAN AMBULAN</strong></label><br>
            ...
            <div class='-content multitab-widget-content-widget-id' id='multicolumn-widget-id5'>
              <span class='sidebar' id='sidebartab3' preferred='yes'>
                <form>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Tindakan Medis/Gawat Darurat</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Pemeriksaan Kesehatan Ibu</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Pemeriksaan Kesehatan Anak</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Pelayanan KB</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Imunisasi </label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Obstetri & Ginekologi</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set AKDR Pasca Plasenta</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Bayi Baru Lahir</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Kegawatan Maternal dan Neonatal</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Perawatan Pasca Persalinan</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Pemeriksaan Khusus</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Kesehatan Gigi dan Mulut</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Komunikasi, Informasi dan Edukasi (KIE) berbagai kebutuhan</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set ASI</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Laboratorium</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Farmasi</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Rawat Inap</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Sterilisasi</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Alat Tambahan untuk Dokter Layanan Primer/Puskesmas sebagai Wahana Pendidikan Dokter Layanan Primer</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Set Puskesmas Keliling</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Kit Keperawatan Kesehatan Masyarakat </label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Kit Imunisasi (<i>Vaccine carrier</i>)</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Kit UKS</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Kit UKGS</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Kit Bidan</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Kit Posyandu</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Kit Sanitarian</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Kit Kesehatan Lansia/Kit Posbindu PTM</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Kit Stimulasi Deteksi dan Intervensi Dini Tumbuh Kembang (SDIDTK)</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Puskesmas sudah tidak menggunakan alat kesehatan yang mengandung air raksa (Hg) untuk tensimeter, termometer, amalgam gigi.</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Alat kesehatan Puskesmas terkalibrasi sesuai peraturan satu tahun sekali</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Puskesmas menggunakan alat kesehatan yang mempunyai ijin edar.</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Alat kesehatan Puskesmas yang telah selesai digunakan diletakan pada tempatnya dalam kondisi rapi dan bersih.</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Puskesmas telah menggunakan alat kesehatan produk dalam negeri</label>
                    <select class="form-control">
                      <option selected>Pilih ...</option>
                      <option value="1">Lengkap</option>
                      <option value="2">Tidak Lengkap</option>
